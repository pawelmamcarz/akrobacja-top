# System Jakości SUS 3.0 + Baza Usług Rozwojowych

**Podmiot:** Doradztwo Paweł Mamcarz · marka **akrobacja.com**
**NIP:** 7122188089 · **Siedziba:** ul. Jesionowa 18, 05-825 Grodzisk Mazowiecki
**Baza operacyjna:** Lotnisko Radom-Piastów (EPRP)
**Status:** Zadeklarowana Organizacja Szkoleniowa (DTO) zgodnie z Załącznikiem VIII Rozporządzenia (UE) 1178/2011

Wersja dokumentu: 1.0 · Data: 2026-05-15

---

## Jak korzystać z tego dokumentu

To **kompletny zestaw dokumentów Systemu Zarządzania Jakością** wymagany do uzyskania:

1. **Certyfikatu SUS 3.0** wydawanego przez DEKRA Certification na zlecenie Polskiej Izby Firm Szkoleniowych (PIFS).
2. **Wpisu do Bazy Usług Rozwojowych (BUR)** prowadzonej przez Polską Agencję Rozwoju Przedsiębiorczości (PARP).
3. Świadczenia usług szkoleniowych dofinansowanych z **BUR / KFS / PUP** (do 90% dofinansowania kosztu kursu).

### Plik źródłowy

Wszystko, czego potrzebujesz, jest w tym jednym pliku. Skopiuj sekcje, których potrzebujesz, do osobnych dokumentów Word/Google Docs. Sugerowana struktura teczki w Google Drive:

```
System Jakości SUS 3.0/
├── SQM-01_Reklamacje.docx
├── SQM-02_Dostepnosc.docx
├── SQM-03_Prawa_Autorskie.docx
├── SQM-04_Analiza_Potrzeb.docx
├── F-01_Karta_Kursanta.docx
├── SQM-05_Ankieta_Ewaluacyjna.docx (lub Google Forms)
├── SQM-06_Procedura_Doskonalenia.docx
├── F-03_Rejestr_Doskonalenia.xlsx
├── SQM-07_Bezpieczenstwo_Danych.docx
├── SQM-08_Wzor_Umowy.docx
├── SQM-09_Checklist_Kursanta.docx
├── SQM-10_Metodyka_Dydaktyczna.docx
├── F-04_Zgoda_Wizerunek.docx
├── Charakterystyka_Dzialalnosci_BUR.docx
├── Opis_Uslugi_BUR_FCL800.docx
├── Opis_Uslugi_BUR_UPRT.docx
├── Mapa_Zgodnosci_SUS_3.0.xlsx
└── /dokumenty-istniejace/
    ├── Program_FCL800.pdf  (z public/program-szkolenia-akrobacja-fcl800.html)
    ├── Deklaracja_DTO.pdf
    ├── Licencja_FI_Maciej_Kulaszewski.pdf
    ├── Dyplomy_Mistrzostw_Swiata_2022.pdf
    └── CofA_EASA_SPEKS.pdf
```
...
- [Plan działania: od dziś do certyfikatu](#plan-działania-od-dziś-do-certyfikatu)
- [Co audytor DEKRA sprawdzi](#co-audytor-dekra-sprawdzi-w-praktyce)
...
## 1. Cel
Procedura określa zasady przyjmowania, rozpatrywania i odpowiadania na reklamacje oraz zastrzeżenia klientów (uczniów-pilotów, zamawiających usługę) Doradztwo Paweł Mamcarz (dalej: DTO) prowadzącego działalność szkoleniową pod marką akrobacja.com.
...
## 3. Zakres zgłoszeń
Procedura obejmuje:
- reklamacje dotyczące jakości szkolenia teoretycznego lub praktycznego,
- zastrzeżenia do realizacji harmonogramu i warunków organizacyjnych,
- zgłoszenia dotyczące materiałów dydaktycznych,
- zgłoszenia związane z bezpieczeństwem lotów (przekazywane natychmiast do Kierownika Szkolenia),
- sytuacje nieprzewidziane (zmiana terminu z powodu pogody, niedyspozycji kadry, problemu technicznego).
...
1. Wnieść odwołanie w terminie 14 dni od otrzymania decyzji do Przedstawiciela DTO (Paweł Mamcarz).
2. Skierować sprawę do Urzędu Lotnictwa Cywilnego (w przypadku reklamacji dotyczących bezpieczeństwa szkolenia lotniczego).
3. Skierować sprawę do sądu powszechnego właściwego dla siedziby DTO.

## 6. Dokumentacja
Każde zgłoszenie rejestrowane w rejestrze reklamacji (skoroszyt Excel / system CRM), zawierającym: datę, dane zgłaszającego, kanał, treść, decyzję, datę odpowiedzi, status.

Rejestr przechowywany jest przez **5 lat** od dnia rozstrzygnięcia.

## 7. Komunikacja klientowi
Procedura dostępna jest:
- na stronie akrobacja.com w stopce („Reklamacje"),
- w treści umowy o szkolenie,
- w mailach potwierdzających rezerwację (link do regulaminu).
...
## 1. Status zgodności
Doradztwo Paweł Mamcarz zobowiązuje się zapewnić dostępność swoich produktów cyfrowych (strona akrobacja.com) i usług szkoleniowych zgodnie z:
- **ustawą z dnia 4 kwietnia 2019 r.** o dostępności cyfrowej stron internetowych i aplikacji mobilnych podmiotów publicznych (w zakresie dobrowolnego stosowania),
...
- minimalne kontrasty tekst/tło zgodne z WCAG AA,
- formularze z etykietami pól (label),
- możliwość nawigacji klawiaturą.

Elementy wymagające poprawy (plan wdrożenia do 30.06.2026):
- pełna weryfikacja kontrastów na wszystkich podstronach,
...
- braku przeciwwskazań kardiologicznych, neurologicznych i ortopedycznych do lotów z przeciążeniami.

Ograniczenia te wynikają z bezpieczeństwa lotów i nie podlegają zmianie. DTO oferuje konsultację indywidualną przed zapisem na szkolenie w celu omówienia dostępności w konkretnej sytuacji.

## 4. Adaptacje, które DTO może zapewnić na zgłoszenie
- materiały teoretyczne w formacie dostosowanym (większa czcionka, kontrast wysoki, audiodeskrypcja przy materiałach video),
- briefing prowadzony w wybranym języku (PL / EN),
- harmonogram dostosowany do indywidualnych potrzeb (np. dłuższe przerwy między sesjami).
...
- na własne potrzeby (utrwalenie kompetencji nabytych podczas szkolenia),
- w okresie 3 lat od dnia zakończenia szkolenia.

Licencja **NIE** obejmuje:
- udostępniania materiałów osobom trzecim,
- modyfikacji, tłumaczenia, opracowywania utworów zależnych,
- wykorzystania komercyjnego (w tym prowadzenia własnych szkoleń na podstawie tych materiałów).

## 3. Nagrania z kamer pokładowych
Materiał wideo z lotu szkoleniowego (kamera zewnętrzna + kabinowa) jest:
- własnością Doradztwo Paweł Mamcarz w aspekcie praw autorskich do nagrania,
- własnością kursanta w aspekcie wizerunku.

Kursant otrzymuje **kopię nagrania na własny użytek** (debriefing, utrwalenie kompetencji). Publikacja w mediach społecznościowych lub innych kanałach jest dozwolona pod warunkiem oznaczenia akrobacja.com.

## 4. Wykorzystanie wizerunku kursanta
Doradztwo Paweł Mamcarz **nie publikuje** nagrań z lotów szkoleniowych zawierających wizerunek kursanta bez **pisemnej zgody** udzielonej w odrębnym dokumencie (Formularz F-04 „Zgoda na wykorzystanie wizerunku").

## 5. Materiały kursanta tworzone w trakcie szkolenia
Notatki, schematy, plany sekwencji akrobacyjnych tworzone osobiście przez kursanta są jego własnością i nie podlegają niniejszej polityce.

## 6. Naruszenia
W przypadku naruszenia niniejszej polityki, Doradztwo Paweł Mamcarz zastrzega prawo dochodzenia roszczeń na podstawie ustawy o prawie autorskim, w tym wniesienia powództwa cywilnego oraz, w przypadku ścigania z urzędu, postępowania karnego (art. 116–117 pr. aut.).
...
## 1. Cel procedury
Identyfikacja potrzeb rozwojowych każdego kursanta przed rozpoczęciem szkolenia FCL.800 w celu:
- zweryfikowania spełnienia wymagań wstępnych FCL.800,
- dopasowania harmonogramu i intensywności do indywidualnego tempa,
- identyfikacji szczególnych potrzeb (zdrowotnych, organizacyjnych, dostępności),
- ustalenia oczekiwanych celów i efektów uczenia się.
...
- harmonogram realny (liczba zjazdów, intensywność),
- ewentualne adaptacje dostępności.
...
```
KARTA KURSANTA
Kurs FCL.800 / Doradztwo Paweł Mamcarz / akrobacja.com
...
WYMAGANIA WSTĘPNE FCL.800
Typ licencji (PPL/LAPL/CPL/ATPL): ........................................
Nr licencji: ........................................
Data wydania: ........................................
Nalot PIC po wydaniu licencji (h): ........................................
Orzeczenie lekarskie klasy: ........................................
Data ważności orzeczenia: ........................................
Waga ciała (kg): ........................................
Przeciwwskazania zdrowotne (deklaracja): TAK / NIE

DOTYCHCZASOWE DOŚWIADCZENIE LOTNICZE
Typy samolotów: ........................................
Nalot łączny: ........................................
Doświadczenie w manewrach z przeciążeniami: TAK / NIE
Doświadczenie w korkociągu/locie odwróconym: TAK / NIE
...
SZCZEGÓLNE POTRZEBY / ADAPTACJE
........................................

HARMONOGRAM USTALONY
Termin szkolenia teoretycznego: ........................................
Plan lotów szkoleniowych: ........................................

PODPISY
Kursant: ........................................ Data: .............
Kierownik Szkolenia: ........................................ Data: .............
```

## 4. Archiwizacja
Wypełnione Karty kursanta przechowywane są przez **3 lata od dnia zakończenia szkolenia** zgodnie z DTO.GEN.220.
...
Ankietę przekazuje się kursantowi po zakończeniu szkolenia (Google Forms lub PDF). Wypełnienie dobrowolne, anonimowe dopuszczalne.
...
6. Komunikacja podczas lotu (intercom, polecenia, korekty):  1–5
...
25. Czego brakowało?
26. Dodatkowe uwagi / sugestie:

DANE OPCJONALNE (do referencji)
Imię i nazwisko (opcjonalnie): ........................................
Czy wyrażasz zgodę na publikację cytatu z ankiety na akrobacja.com? TAK / NIE
```

Wyniki agreguje Przedstawiciel DTO po każdej grupie szkoleniowej i wykorzystuje zgodnie z procedurą SQM-06.
...
|---|---|---|
| Średnia zadowolenia (pyt. 1) | 4,0 | 4,5 |
| NPS (pyt. 2) | 7 | 9 |
| Średnia oceny instruktora (pyt. 3–8) | 4,5 | 4,8 |
| Średnia oceny materiałów (pyt. 11) | 4,0 | 4,5 |
| Skuteczność (egzamin praktyczny, % zaliczeń) | 90 % | 100 % |
| Liczba reklamacji / kwartał | ≤ 1 | 0 |

## 4. Schemat decyzyjny
Po każdym przeglądzie kwartalnym Przedstawiciel DTO + Kierownik Szkolenia:
1. Analizują wyniki ankiet (średnie, anomalie, wolny tekst).
2. Identyfikują 1–3 słabe punkty.
3. Definiują działania doskonalące (np. „dodać 30 min teorii o AGSM", „zmienić sekwencję figur w etapie II", „uaktualnić skrypt").
4. Określają termin wdrożenia i odpowiedzialnego.
5. Wynik dokumentują w **Rejestrze doskonalenia (F-03)**.

## 5. Komunikacja zwrotna
Wyniki ewaluacji + plan doskonalenia są:
- archiwizowane w teczce kursu,
- udostępniane Kierownikowi Szkolenia (Maciej Kulaszewski),
- raz w roku komunikowane przyszłym kursantom w formie skróconego raportu publicznego na akrobacja.com („Co poprawiliśmy w 2026 r.").

## 6. Rejestr doskonalenia (formularz F-03)
| Data | Źródło | Zidentyfikowany problem | Działanie | Termin | Odpowiedzialny | Status |
|---|---|---|---|---|---|---|
...
- dane lotnicze: typ i numer licencji, nalot, orzeczenie lekarskie;
- dane finansowe: NIP (jeśli faktura na firmę), historia płatności;
- dane sesyjne: token sesji (przechowywany jako hash SHA-256), IP, user agent;
- nagrania wideo z lotów szkoleniowych.

## 4. Czas przechowywania
- dokumentacja szkolenia FCL.800: **3 lata** od daty zakończenia (DTO.GEN.220);
- dokumentacja finansowa (faktury, umowy): **5 lat** od końca roku podatkowego;
...
- HTTPS + HSTS + CSP na poziomie aplikacji.

## 6. Prawa osoby, której dane dotyczą
- dostęp, sprostowanie, usunięcie („prawo do bycia zapomnianym"), ograniczenie przetwarzania;
- przenoszenie danych;
- sprzeciw;
...
```
UMOWA O SZKOLENIE LOTNICZE NR ...../2026

zawarta w dniu .................. roku w Grodzisku Mazowieckim
pomiędzy:

DORADZTWO PAWEŁ MAMCARZ, ul. Jesionowa 18, 05-825 Grodzisk Mazowiecki,
NIP 7122188089, REGON .........., zwany dalej „DTO",
reprezentowanym przez Pawła Mamcarza,
...
zamieszkałym/ą w .........................................,
PESEL: ..............................................,
zwanym/zwaną dalej „Kursantem",

zwanymi łącznie „Stronami".

§ 1. PRZEDMIOT UMOWY
1. DTO zobowiązuje się przeprowadzić szkolenie lotnicze do uzyskania
   uprawnienia akrobacji samolotowej zgodnie z pkt FCL.800
   Rozporządzenia Komisji (UE) nr 1178/2011, w wymiarze: 8 godzin
   szkolenia teoretycznego + 5 godzin szkolenia praktycznego w locie
   (10 lotów) na samolocie Extra 300L (SP-EKS).
2. Szkolenie realizowane jest na lotnisku Radom-Piastów (EPRP).
3. Szczegółowy program szkolenia stanowi załącznik nr 1 do niniejszej
   umowy.

§ 2. WYNAGRODZENIE
1. Wynagrodzenie należne DTO za realizację szkolenia wynosi
   20 900 zł netto (słownie: dwadzieścia tysięcy dziewięćset zł).
2. Usługa szkoleniowa jest zwolniona z VAT na podstawie art. 43 ust. 1
   pkt 29 lit. a ustawy o VAT.
3. Płatność: ......................................

§ 3. WYMAGANIA WSTĘPNE
Kursant oświadcza, że spełnia wymagania pkt FCL.800(a):
- posiada ważną licencję PPL(A)/LAPL(A)/CPL(A)/ATPL(A) nr ..........;
- ma co najmniej 40 godzin nalotu jako pilot dowódca po uzyskaniu
  licencji;
- posiada ważne orzeczenie lotniczo-lekarskie klasy ......., ważne
  do dnia .........;
- nie posiada przeciwwskazań zdrowotnych do lotów z przeciążeniami.

§ 4. PRAWA AUTORSKIE
Materiały dydaktyczne stanowią wyłączną własność DTO. Kursant
otrzymuje niewyłączną licencję na korzystanie z materiałów na
zasadach określonych w Polityce praw autorskich (SQM-03).

§ 5. DANE OSOBOWE
Przetwarzanie danych osobowych Kursanta odbywa się na zasadach
opisanych w Polityce bezpieczeństwa danych (SQM-07), stanowiącej
załącznik nr 2 do niniejszej umowy.

§ 6. WIZERUNEK
Kursant nie wyraża automatycznej zgody na wykorzystanie swojego
wizerunku z lotów szkoleniowych w materiałach marketingowych DTO.
Zgoda taka, jeśli zostanie udzielona, podlega odrębnemu pisemnemu
oświadczeniu (F-04).

§ 7. PRZECIWWSKAZANIA I BEZPIECZEŃSTWO
1. Kursant zobowiązuje się stosować do poleceń instruktora w trakcie
   lotów.
2. Instruktor ma prawo przerwać szkolenie w każdym momencie ze
   względów bezpieczeństwa.
3. Kursant ma prawo odmówić wykonania ćwiczenia w razie złego
   samopoczucia.

§ 8. ZMIANA TERMINU
1. Loty odwołane z powodu warunków pogodowych są przekładane
   bezpłatnie na nowy termin uzgodniony pomiędzy Stronami.
2. Kursant może bezpłatnie przełożyć termin lotu na co najmniej 48 h
   przed planowaną sesją.

§ 9. REKLAMACJE
Reklamacje rozpatrywane są zgodnie z Procedurą reklamacji (SQM-01).
Klient potwierdza, że zapoznał się z procedurą.

§ 10. POSTANOWIENIA KOŃCOWE
1. W sprawach nieuregulowanych umową zastosowanie mają przepisy
   Kodeksu cywilnego oraz przepisy lotnicze.
2. Spory rozstrzyga sąd właściwy dla siedziby DTO.
3. Umowa sporządzona w dwóch egzemplarzach, po jednym dla każdej
   ze Stron.
...
═══════════════════════════════════════════════════════════
[ ] Licencja pilota (oryginał + kserokopia)
[ ] Książka lotów (logbook)
[ ] Orzeczenie lotniczo-lekarskie klasy 1 lub 2 (ważne)
[ ] Dowód osobisty lub paszport
[ ] Podpisana umowa o szkolenie (przesłana wcześniej)

═══════════════════════════════════════════════════════════
B. PRZYGOTOWANIE MERYTORYCZNE
═══════════════════════════════════════════════════════════
[ ] Lektura skryptu „Kurs akrobacji samolotowej FCL.800"
    (PDF wysyłany 7 dni przed kursem)
[ ] Zapoznanie się z notacją figur akrobacyjnych Aresti
    (rozdział 3 skryptu)
[ ] Zapoznanie się z procedurami awaryjnymi Extra 300L
    (rozdział 4 skryptu)
[ ] Obejrzenie 3 filmów referencyjnych (linki w mailu)
...
[ ] Brak leków psychoaktywnych, antyhistaminowych,
    przeciwbólowych w dniu lotu
[ ] Co najmniej 8 h snu poprzedniej nocy
[ ] Brak intensywnego wysiłku fizycznego 12 h przed lotem

═══════════════════════════════════════════════════════════
D. UBRANIE I AKCESORIA
═══════════════════════════════════════════════════════════
[ ] Wygodne ubranie sportowe (NIE klapki)
[ ] Solidne buty pełne (trampki/półbuty)
[ ] Okulary przeciwsłoneczne (zalecane)
[ ] Korekta wzroku (jeśli używasz, zabierz zapasową)

═══════════════════════════════════════════════════════════
E. DOJAZD I LOGISTYKA
═══════════════════════════════════════════════════════════
[ ] Lotnisko Radom-Piastów (EPRP), ul. Lotników 1,
    26-600 Radom
...
- nagrania video pozostają u kursanta,
- możliwość konsultacji follow-up (1× godzina mailowa lub telefon w okresie 12 miesięcy po szkoleniu, w cenie),
- zaproszenie do społeczności pilotów akrobacyjnych (grupa zamknięta, kontakty),
- rekomendacja terminów do dalszego doskonalenia (camp akrobacyjny, sesje proficiency).

## 7. Monitorowanie skuteczności metodyki
- standardowa ankieta ewaluacyjna po każdym kursie (F-02),
- przegląd kwartalny wyników (SQM-06),
- obserwacja wskaźnika zdawalności sprawdzianu końcowego (cel: 100 %).
...
Formularz F-04 / wer. 1.0 / Doradztwo Paweł Mamcarz
══════════════════════════════════════════════════════════════════

DANE UDZIELAJĄCEGO ZGODY (KURSANTA)

Imię i nazwisko: ........................................

PESEL (do weryfikacji tożsamości): ........................................

Adres e-mail: ........................................

Telefon: ........................................

Numer umowy szkolenia: ........................................

──────────────────────────────────────────────────────────────────

TREŚĆ ZGODY

Niniejszym, działając dobrowolnie, w pełni świadomy/a swoich praw,
wyrażam zgodę:

A. NA WYKORZYSTANIE MOJEGO WIZERUNKU
   utrwalonego podczas szkolenia akrobacji samolotowej FCL.800 /
   szkolenia UPRT / lotu zapoznawczego* prowadzonego przez
   Doradztwo Paweł Mamcarz (NIP 7122188089) na samolocie Extra 300L
   (SP-EKS), w tym na zdjęciach i nagraniach z kamer pokładowych
   (wewnętrznej i zewnętrznej) oraz fotografiach z lotniska.

   * niepotrzebne skreślić

B. NA UŻYCIE TEGO WIZERUNKU PRZEZ DTO W NASTĘPUJĄCYCH ZAKRESACH
   [zaznacz, w których chcesz wyrazić zgodę]:

   [ ] B1. Strona internetowa akrobacja.com (galeria, blog,
            opinie kursantów)
   [ ] B2. Media społecznościowe DTO: Instagram (@akrobacja_com),
            Facebook (akrobacjacom)
   [ ] B3. Materiały marketingowe drukowane (ulotki, plakaty,
            roll-upy)
   [ ] B4. Materiały dydaktyczne dla przyszłych kursantów
            (analiza pokazowa w briefingach)
   [ ] B5. Filmy promocyjne i reportaże w mediach (TV, YouTube,
            podcasty)
   [ ] B6. Wszystkie powyższe (B1-B5)

C. NA TOWARZYSZĄCE INFORMACJE
   [ ] C1. Imię (np. „Anna Z." lub pełne imię i nazwisko, jeśli
            podpisana zostanie również opinia/cytat)
   [ ] C2. Pełne imię i nazwisko
   [ ] C3. Anonimowo (tylko wizerunek, bez podpisu)

──────────────────────────────────────────────────────────────────

OKRES OBOWIĄZYWANIA ZGODY

Zgoda zostaje udzielona na okres ......... lat licząc od daty
podpisania (rekomendowany okres: 5 lat).
...
4. że materiały wykonane na podstawie udzielonej zgody mogą zostać
   wykorzystane przed jej odwołaniem (np. opublikowany post pozostaje
   opublikowany, ale DTO usunie go w terminie 14 dni od pisemnego
   wniosku, o ile jest to technicznie możliwe);
5. że za udzielenie zgody nie przysługuje mi wynagrodzenie
   (zgodnie z art. 81 ust. 2 ustawy o prawie autorskim
   i prawach pokrewnych);
6. że administratorem danych osobowych (w tym wizerunku) jest
   Doradztwo Paweł Mamcarz, ul. Jesionowa 18, 05-825 Grodzisk
   Mazowiecki, NIP 7122188089; szczegóły przetwarzania znajdują
   się w Polityce bezpieczeństwa danych (SQM-07).

──────────────────────────────────────────────────────────────────

ZAKRES, KTÓREGO ZGODA NIE OBEJMUJE

DTO oświadcza, że nie będzie wykorzystywać wizerunku Kursanta:
- w kontekście kompromitującym, ośmieszającym lub naruszającym
  dobre imię;
- w reklamie produktów lub usług osób trzecich (DTO nie odsprzedaje
  praw do wizerunku);
- w celu wykorzystania komercyjnego bez wiedzy Kursanta wykraczającego
  poza zakres określony w pkt B powyżej.
...
Podpis Kursanta:               Potwierdzenie DTO:
...
## 2. Rodzaj usługi
Usługa szkoleniowa zawodowa (kwalifikacyjna), forma stacjonarna (in-person).
...
- Identyfikuje procedury awaryjne, w tym awaryjne opuszczenie samolotu z użyciem spadochronu ratunkowego.
...
- Zaplanować i zrealizować sekwencję akrobacyjną złożoną z minimum 5 figur z utrzymaniem osi lotu, prawidłowym zarządzaniem energią i bezpiecznymi marginesami wysokości.
...
## 5. Grupa docelowa
- Piloci posiadający ważną licencję **PPL(A)**, **LAPL(A)**, **CPL(A)** lub **ATPL(A)**.
- Piloci sportowi oraz piloci general aviation chcący rozszerzyć kompetencje o akrobację.
- Instruktorzy lotniczy (FI/CRI) zainteresowani uzyskaniem uprawnienia do nauczania akrobacji.
- Piloci komercyjni (loty pokazowe, agrolotnictwo) podnoszący kompetencje w zakresie wyprowadzania samolotu z położeń nietypowych.

## 6. Wymagania wstępne dla uczestnika (zgodne z FCL.800)
1. Ważna licencja: **PPL(A)**, **LAPL(A)**, **CPL(A)** lub **ATPL(A)**.
2. Nalot co najmniej **40 godzin jako pilot dowódca (PIC)** na samolotach lub TMG **po uzyskaniu licencji**.
3. Ważne orzeczenie lotniczo-lekarskie **klasy 1 lub klasy 2**.
4. Brak przeciwwskazań zdrowotnych do wykonywania lotów z przeciążeniami.
5. Masa ciała umożliwiająca spełnienie ograniczeń wagowo-balansowych samolotu Extra 300L (do 110 kg).

## 7. Liczba godzin szkolenia
| Część | Liczba godzin |
|---|---|
| Szkolenie teoretyczne (wykłady, prezentacje, ćwiczenia) | **8 godz.** |
| Szkolenie praktyczne (loty z instruktorem na Extra 300L) | **5 godz. (minimum 10 lotów)** |
| Briefingi przedlotowe i debriefingi (w cenie, poza godzinami w locie) | ok. 8 godz. |
| **Łącznie zajęć dydaktycznych (kontaktowych)** | **21 godz.** |
...
- Karty figur akrobacyjnych w notacji Aresti.
- Dostęp do nagrań video z własnych lotów (kamera zewnętrzna + kabinowa) wraz z analizą instruktora.
...
**Zaświadczenie o ukończeniu szkolenia (Certificate of Completion)** wydane przez Doradztwo Paweł Mamcarz (DTO) na podstawie pkt DTO.GEN.230 Rozporządzenia 1178/2011. Stanowi podstawę do złożenia wniosku do **Prezesa Urzędu Lotnictwa Cywilnego** o wpis uprawnienia do wykonywania lotów akrobacyjnych do licencji pilota.

## 13. Maksymalna liczba uczestników w grupie
**1 uczestnik** w trybie indywidualnym (lot na dwumiejscowym Extra 300L z instruktorem to relacja 1:1). Możliwe szkolenie grupowe w części teoretycznej (do 6 uczestników), z indywidualnym harmonogramem części praktycznej.
...
- Ponad **3 000 godzin nalotu** na samolocie typu Extra 300L.
- Czynny zawodnik startujący w Mistrzostwach Świata.

## 16. Sprzęt szkoleniowy
**Extra 300L, znaki rejestracyjne SP-EKS**, certyfikat zdatności CofA EASA, silnik Lycoming AEIO-580 (300 KM), certyfikowana obwiednia akrobacyjna ±10 G, samolot dwumiejscowy tandem, wyposażenie kabiny w spadochrony ratunkowe.

## 17. Cena
**20 900 PLN netto** za pełny kurs (8 godz. teorii + 5 godz. praktyki w locie + briefingi, materiały, ubezpieczenie, wyposażenie, sprawdzian końcowy, zaświadczenie o ukończeniu).
...
- Rozpoznać niezamierzony korkociąg odwrócony i prawidłowo z niego wyjść.
- Wyprowadzić samolot z położenia ekstremalnego (przechylenie >60°, kąt natarcia krytyczny, nos w dół >30°).
...
- Piloci wojskowi w okresie konwersji na lotnictwo cywilne.

## 6. Wymagania wstępne dla uczestnika
1. Ważna licencja: **PPL(A)**, **LAPL(A)**, **CPL(A)** lub **ATPL(A)**.
2. Ważne orzeczenie lotniczo-lekarskie klasy 1 lub 2.
3. Brak przeciwwskazań zdrowotnych do lotów z przeciążeniami (do ±4 G).
4. Masa ciała umożliwiająca spełnienie ograniczeń C/G samolotu Extra 300L (do 110 kg).

**Brak** wymogu wcześniejszego doświadczenia w akrobacji.

## 7. Liczba godzin szkolenia
| Część | Liczba godzin |
|---|---|
| Szkolenie teoretyczne | **4 godz.** |
| Szkolenie praktyczne (loty z instruktorem) | **3 godz. (6 lotów)** |
| Briefingi przedlotowe i debriefingi (w cenie) | ok. 5 godz. |
| **Łącznie godzin kontaktowych** | **12 godz.** |

Szkolenie realizowane w trybie **1 zjazd 2-dniowy** lub **2 zjazdy weekendowe** (do uzgodnienia).
...
- **Praktyka:** lot szkoleniowy na dwumiejscowym samolocie akrobacyjnym Extra 300L (SP-EKS), kompletny briefing przedlotowy + debriefing po locie z analizą zapisu kamer pokładowych.
- **Metodyka:** **demonstration → practice → correction** + **startle scenarios** w finalnym locie.

## 10. Materiały szkoleniowe (w cenie)
- Skrypt teoretyczny „UPRT na Extra 300L" (PDF, ok. 40 stron).
- Karty procedur awaryjnych (PARE, dive recovery, unusual attitude recovery).
- Nagrania video z własnych lotów z analizą instruktora.
- Pełne wyposażenie ratunkowe: spadochron, kask, headset.
...
2. **Część praktyczna** — samodzielne wyjście z **3 różnych położeń nietypowych** wprowadzonych przez instruktora ("startle"), oceniane wg kryteriów:
   ...
   - brak przekroczenia obwiedni samolotu.

## 12. Dokument wydawany po ukończeniu
**Zaświadczenie o ukończeniu szkolenia UPRT** wydane przez Doradztwo Paweł Mamcarz (DTO), zgodne z wymaganiami:
- ICAO Doc 10011,
- EASA AMC1 FCL.745.A (w zakresie advanced UPRT),
- standardami operatorów liniowych w zakresie szkolenia okresowego.

Zaświadczenie jest **akceptowane przez operatorów lotniczych** jako element szkolenia okresowego oraz przez ULC jako spełnienie wymogu FCL.745.A.

## 13. Maksymalna liczba uczestników w grupie
**1 uczestnik** w trybie indywidualnym (relacja 1:1 z instruktorem na dwumiejscowym Extra 300L). Część teoretyczna może być prowadzona dla grupy do 6 osób z indywidualnym harmonogramem części praktycznej.
...
# Mapa zgodności SUS 3.0 ↔ dokumenty SQM
...
| # | Treść standardu | Pokrywający dokument SQM | Dodatkowe dowody | Możliwe pytania audytora | Status |
|---|---|---|---|---|---|
| **2.1** | Analiza i diagnoza potrzeb | **SQM-04** (procedura) | Karta kursanta F-01, zapisy z konsultacji wstępnych | Pokażcie kartę ostatniego kursanta. Jak diagnozujecie potrzeby? | ✅ po wdrożeniu SQM-04 |
...
| # | Treść standardu | Pokrywający dokument SQM | Dodatkowe dowody | Możliwe pytania audytora | Status |
|---|---|---|---|---|---|
| **4.1** | Przygotowanie klienta do usługi | **SQM-09** | checklist wysyłany 7 dni przed kursem, materiały teoretyczne PDF | Co kursant otrzymuje przed pierwszym dniem szkolenia? | ✅ po wdrożeniu SQM-09 |
| **4.2** | Praktyki angażujące klientów | **SQM-10** (metodyka DPC) | opis demonstration-practice-correction, samokontrolna analiza video | Jak angażujecie kursanta podczas lotu? | ✅ po wdrożeniu SQM-10 |
| **4.3** | Przetwarzanie i udostępnianie danych | **SQM-07** + **SQM-08** (umowa) | klauzule w umowie, kopia nagrań przekazywana kursantowi | Co kursant dostaje z waszej strony po szkoleniu? | ✅ |
...
## Mapa odwrotna: który SQM pokrywa które punkty SUS

| Dokument | Pokrywane punkty SUS 3.0 |
|---|---|
| **SQM-01** Reklamacje | 1.6 |
| **SQM-02** Dostępność | 1.9, 2.3, 3.5, 4.5 |
| **SQM-03** Prawa autorskie | 1.3 |
| **SQM-04** Analiza potrzeb + Karta | 2.1, 2.2, 3.5, 4.4 |
| **SQM-05** Ankieta ewaluacyjna | 5.2 |
| **SQM-06** Procedura ewaluacji i doskonalenia | 5.4 |
| **SQM-07** Bezpieczeństwo danych | 1.3, 1.5, 4.3 |
| **SQM-08** Umowa o szkolenie | 1.3, 4.3 |
| **SQM-09** Checklist kursanta | 4.1, 4.5 |
| **SQM-10** Metodyka dydaktyczna | 3.1, 4.2, 4.4, 5.1 |
| **F-01** Karta kursanta | 2.1, 2.2, 4.4 |
| **F-02** Ankieta ewaluacyjna | 5.2 |
| **F-03** Rejestr doskonalenia | 5.4 |
| **F-04** Zgoda na wizerunek | 1.3 |
| Program FCL.800 (już macie) | 1.4, 3.1, 3.2, 3.3, 5.3 |
| Dokumentacja DTO (już macie) | 1.1, 1.7, 1.8, 3.4, 4.5 |
| Strona akrobacja.com (już macie) | 1.1, 1.2 |

**31 punktów standardu SUS 3.0**, w tym:
...
2. Wewnątrz utwórz pliki:
   ...
   - `SQM-02_Dostepnosc.docx`
   - `SQM-03_Prawa_Autorskie.docx`
   - `SQM-04_Analiza_Potrzeb.docx` + `F-01_Karta_Kursanta.docx`
   - `SQM-05_Ankieta_Ewaluacyjna.docx` (lub Google Forms z linkiem)
   - `SQM-06_Procedura_Doskonalenia.docx` + `F-03_Rejestr_Doskonalenia.xlsx`
   - `SQM-07_Bezpieczenstwo_Danych.docx`
   - `SQM-08_Wzor_Umowy.docx`
   - `SQM-09_Checklist_Kursanta.docx`
   - `SQM-10_Metodyka_Dydaktyczna.docx`
   - `F-04_Zgoda_Wizerunek.docx`
   - `Mapa_Zgodnosci_SUS_3.0.xlsx`
3. Skopiuj dodatkowo do tej samej teczki:
   - Program szkolenia FCL.800 (z `public/program-szkolenia-akrobacja-fcl800.html`).
   - Opis usługi UPRT (z poprzedniej rundy).
   - Deklarację DTO.
...
# Co audytor DEKRA sprawdzi w praktyce
...
**Najczęstsze wpadki:**
- Dokumenty są, ale są ze sobą sprzeczne (np. SQM-01 mówi o 14 dniach, regulamin na stronie o 30).
- Brak konkretnych dowodów wdrożenia (np. macie procedurę ewaluacji, ale brak ani jednej ankiety wypełnionej).
- Wizerunek/RODO klauzule różne w różnych dokumentach.

**Rozwiązanie:** wszystkie dokumenty z tego pliku są ze sobą spójne (te same daty, terminy, dane firmy). Wystarczy nie modyfikować ich bez koordynacji.

---

# Załącznik: Lista dokumentów do okazania audytorowi

Lista, którą można wydrukować i mieć pod ręką podczas audytu zdalnego:
...
| 16 | SQM-03 Polityka praw autorskich | ✅ | system-jakosci/ |
| 17 | SQM-04 Analiza potrzeb + Karta F-01 | ✅ | system-jakosci/ |
| 18 | SQM-05 Ankieta ewaluacyjna F-02 | ✅ | system-jakosci/ |
| 19 | SQM-06 Procedura doskonalenia + F-03 | ✅ | system-jakosci/ |
| 20 | SQM-07 Polityka bezpieczeństwa danych | ✅ | system-jakosci/ |
| 21 | SQM-08 Wzór umowy o szkolenie | ✅ | system-jakosci/ |
| 22 | SQM-09 Checklist kursanta | ✅ | system-jakosci/ |
| 23 | SQM-10 Metodyka dydaktyczna | ✅ | system-jakosci/ |
| 24 | F-04 Zgoda na wizerunek | ✅ | system-jakosci/ |
| 25 | Mapa zgodności SUS 3.0 | ✅ | system-jakosci/ |
| 26 | Skrypt teoretyczny FCL.800 (PDF) | 🟡 | materialy-dydaktyczne/ |
| 27 | Karty figur Aresti | 🟡 | materialy-dydaktyczne/ |
| 28 | Rejestr reklamacji (Excel) | ⚪ pusty | rejestry/ |
| 29 | Rejestr doskonalenia (Excel) | ⚪ pusty | rejestry/ |
| 30 | Próbka 3-5 wypełnionych ankiet F-02 | 🟡 do zebrania | rejestry/ |

Legenda: ✅ gotowe · 🟡 do dopracowania · ⚪ pusty wzór do uzupełnienia w trakcie pracy
