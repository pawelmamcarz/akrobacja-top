...
Aktualny stan: maj 2026. Źródła: BGK, portal ogólnopolski pożyczkinaksztalcenie.pl, Ministerstwo Funduszy i Polityki Regionalnej.
...
- **Brak prowizji, brak opłat dodatkowych**
- **Maksymalna kwota:** **75 000 zł** (limit podniesiony z 50 000 zł w kwietniu 2025)
- **Okres spłaty:** **do 36 miesięcy**
- **Umorzenie kapitału po ukończeniu kursu:**
  - **25%** standardowo (każdy kursant)
  - **+10%** jeśli operator zakwalifikuje kurs do strategicznego obszaru
  - **+15%** jeśli udokumentujesz trudną sytuację materialną
  - **Łącznie do 50%** umorzenia
- **Środki idą bezpośrednio do organizatora szkolenia** (akrobacja.com / Aeroklub Radomski), nie na konto kursanta

---

## Dlaczego ta pożyczka jest dobra dla kursu FCL.800

| Parametr | Pożyczka | Kurs FCL.800 akrobacja.com |
|---|---|---|
| Limit kwoty | 75 000 zł | 20 900 zł |
| Max długość kursu | 36 miesięcy | 4–6 miesięcy |
| Forma kształcenia | kursy zawodowe pozaakademickie | szkolenie zawodowe DTO |
| Wymaganie | pełnoletni, mieszkaniec PL | brak wieku górnego, wymaga PPL(A) |

Kurs FCL.800 mieści się we wszystkich wymaganiach pożyczki z dużym zapasem. Limit 75 000 zł oznacza że jedna pożyczka może też pokryć **Camp Akrobacyjny + FCL.800** (~28 000 zł razem).

---

## Kto może wziąć tę pożyczkę
...
- Student
- Bezrobotny (ale wtedy operator zwykle pyta o źródło spłaty)
...
- **Dowód osobisty** (skan/zdjęcie obu stron)
- **Potwierdzenie dochodu:**
  - Umowa o pracę → kopia umowy + 3 ostatnie paski wypłat
  - B2B → wyciąg z CEIDG + zaświadczenie z US o niezaleganiu + 3 ostatnie wyciągi konta firmowego
...
Operator weryfikuje:
- Zdolność kredytową
- Wiarygodność dokumentów dochodowych
...
- Nie obracasz gotówką
- Nie ma ryzyka że pieniądze gdzieś znikną
- Otrzymujesz potwierdzenie z banku operatora + my potwierdzamy zaksięgowanie
...
- **Sezonowo:** kwiecień–październik (warunki pogodowe pozwalają na akrobację)
- **Czas trwania:** 4–6 miesięcy (zależnie od pogody i dostępności)
...
**Dokumenty potrzebne:**
- Świadectwo ukończenia kursu FCL.800 (wystawia akrobacja.com / Aeroklub Radomski)
- Potwierdzenie wpisu do licencji ULC
- Wniosek o umorzenie (formularz operatora)

**Procent umorzenia:**

| Składowa | Warunek | Wartość |
|---|---|---|
| Podstawowe umorzenie | Ukończenie kursu | **25%** |
| Bonus za strategiczny obszar | Operator kwalifikuje lotnictwo/transport | +10% |
| Bonus za sytuację materialną | Dokumentacja niskich dochodów | +15% |
| **Maksymalne łączne umorzenie** | Wszystkie warunki spełnione | **50%** |
...
- **0% odsetek**
- **0 prowizji**
- Spłacasz wyłącznie kapitał pomniejszony o umorzenie

Rata miesięczna jest stała (kapitał / liczba miesięcy).

---

## Matematyka dla FCL.800 (cena 20 900 zł)

| Scenariusz | Pozostały kapitał | Rata 36 miesięcy |
|---|---|---|
| Bez umorzenia (jeśli ktoś nie wystąpił po świadectwie) | 20 900 zł | ~581 zł |
| **Standardowe 25%** | 15 675 zł | **~435 zł** |
| 35% (z bonusem strategicznym) | 13 585 zł | ~377 zł |
| 40% (z bonusem materialnym) | 12 540 zł | ~348 zł |
| **Maksymalne 50%** (strategiczny + materialny) | 10 450 zł | **~290 zł** |

**Wniosek:** w najczęstszym scenariuszu (25% umorzenia) klient płaci za FCL.800 około 435 zł miesięcznie przez 3 lata.

---

## Łączenie pożyczki z BUR / KFS / PUP

Pożyczka 0% **nie wyklucza** innych źródeł dofinansowania. Często łączy się ją z BUR aby pokryć wkład własny.

### Przykład: BUR 90% + Pożyczka 0% na wkład własny

| Etap | Kwota |
|---|---|
| Cena kursu | 20 900 zł |
| BUR pokrywa 90% | 18 810 zł |
| **Wkład własny do pokrycia** | **2 090 zł** |
| Pożyczka 0% pokrywa te 2 090 zł | 2 090 zł |
| Po umorzeniu 50% pożyczki | 1 045 zł do spłaty |
| Rata 36 miesięcy | **~29 zł / mies.** |

**Klient płaci całkowity koszt kursu FCL.800 w wysokości ~1 045 zł rozłożone na 36 miesięcy po 29 zł.**

---

## Jak wystawiam ofertę szkolenia FCL.800

Gdy klient pyta o pożyczkę, ma zazwyczaj 3 pytania:

1. **„Ile mnie to faktycznie kosztuje?"** → odpowiedź z tabeli powyżej.
2. **„Co potrzebuję od was do wniosku?"** → oferta szkolenia (PDF lub email).
3. **„Czy mi pomożecie z formalnościami?"** → tak, na każdym etapie.

### Standardowy szablon oferty szkolenia (PDF/email):

```
OFERTA SZKOLENIA AKROBACYJNEGO FCL.800

Wydany przez: akrobacja.com (Doradztwo Paweł Mamcarz)
DTO operator: Aeroklub Radomski
Lotnisko: Radom-Piastów (EPRP), ul. Lotników 1, 26-600 Radom

Nazwa kursu: Kurs uprawnień akrobacyjnych FCL.800
Numer ewidencyjny ULC: [numer DTO Aeroklubu Radomskiego]
Program: zgodny z EASA Part-FCL FCL.800 + Annex I do Rozp. 1178/2011

Zakres:
- Minimum 5 godzin nalotu szkoleniowego (FCL.800(b)(2))
- Min. 4 godziny instruktażu na ziemi (briefingi + debriefingi)
- Zaliczenie egzaminu wewnętrznego DTO
- Wystawienie świadectwa ukończenia + wpis do licencji ULC

Samolot szkoleniowy: Extra 300L SP-EKS (akrobacyjny, 2-osobowy)
Instruktor: Maciej Kulaszewski FI(A), Wielokrotny Mistrz Świata w Akrobacji

Cena: 20 900 zł, zwolnione z VAT (art. 43 ust. 1 pkt 29 lit. a Ustawy o VAT)

Termin: sezon kwiecień-październik [rok]
Czas realizacji: 4-6 miesięcy

Wymagania wstępne: licencja PPL(A) ważna na dzień rozpoczęcia kursu

Akceptujemy dofinansowanie z:
- BUR (Baza Usług Rozwojowych)
- KFS (Krajowy Fundusz Szkoleniowy)
- PUP (Powiatowy Urząd Pracy)
- Pożyczka na Kształcenie BGK (Postaw na Rozwój / FERS)

Konto bankowe do przelewu:
[Numer konta akrobacja.com / Aeroklub Radomski]
```

Klient załącza ten PDF/email do wniosku w pozyczkinaksztalcenie.pl.
...
1. **Ofertę szkolenia FCL.800** (PDF, na firmowym papierze akrobacja.com)
2. **Program szkolenia FCL.800** (publicznie dostępny: [/program-szkolenia-akrobacja-fcl800](https://akrobacja.com/program-szkolenia-akrobacja-fcl800))
3. **Numer ewidencyjny DTO** Aeroklubu Radomskiego (do umieszczenia w ofercie)
4. **Konto bankowe** do przelewu od operatora pożyczki

Czas wystawienia: **24 godziny w dni robocze**.
...
Maj 2026. Po istotnych zmianach w warunkach pożyczki, zaktualizuj ten dokument.

Główne ostatnie zmiany:
- **Kwiecień 2025:** podniesienie limitu z 50 000 zł do 75 000 zł
- **Kwiecień 2025:** wprowadzenie ogólnopolskiego systemu (jeden portal pozyczkinaksztalcenie.pl)
- **Kwiecień 2025:** zwiększenie maksymalnego umorzenia z 35% do 50%
