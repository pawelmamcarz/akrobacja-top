...
const TOPICS = [
  {
    ...
    description: 'Limit wagi w Extra 300L to 110 kg. Jak waga pasażera wpływa na środek ciężkości, dynamikę lotu, przeciążenia i ilość paliwa. Konkretne liczby i FAQ.',
    keywords: 'waga pasażera akrobacja, limit waga lot akrobacyjny, Extra 300L masa, ciężar pasażera akrobacja, ile ważyć żeby polecieć',
    ogShortDesc: 'Limit 110 kg w Extra 300L. Jak Twoja waga zmienia dynamikę lotu i paliwo. Konkretne liczby.',
    twitterTitle: 'Jak waga wpływa na lot akrobacyjny',
    highlightBox: 'Limit wagi pasażera w Extra 300L SP-EKS to 110 kg. Powyżej tego nie polecisz, niżej masz pełen program. Twoja waga zmienia dynamikę figur, paliwo i długość lotu, ale nie obniża bezpieczeństwa.',
  },
  {
    slug: 'historia-polskiej-akrobacji-lotniczej',
    h1: 'Historia polskiej akrobacji lotniczej',
    description: 'Od Stanisława Skarżyńskiego, przez Iwo Rutkowskiego, do Macieja Kulaszewskiego. 100 lat polskich pilotów akrobacyjnych, mistrzostw i samolotów.',
    keywords: 'historia polskiej akrobacji, polscy piloci akrobacja, Iwo Rutkowski, Stanisław Skarżyński, Maciej Kulaszewski Mistrz Świata, polska szkoła akrobacji',
    ogShortDesc: 'Od Skarżyńskiego do Mistrza Świata 2022. 100 lat polskiej akrobacji lotniczej w jednym tekście.',
    twitterTitle: 'Historia polskiej akrobacji lotniczej',
    highlightBox: 'Polska akrobacja lotnicza ma ponad 100 lat. Od Skarżyńskiego i Żwirki, przez Iwo Rutkowskiego, po Macieja Kulaszewskiego (Mistrz Świata 2022). Krótki przegląd najważniejszych nazwisk i wydarzeń.',
  },
  {
