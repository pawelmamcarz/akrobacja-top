> SOURCE TEKSTU dla `/public/blog/atam-37-air-to-air-meeting.html`.
> Edytuj tu w Obsidianie — daj mi znać "zsynchronizuj atam 37" a wprowadzę zmiany do HTML.
> Nie ruszaj tagów / metadanych w HTML, ja je dotknę przy syncu.

23 maja 2026 &middot; Paweł Mamcarz, Maciej Kulaszewski
...
> **Gospodarz:** Aeroklub Ziemi Piotrkowskiej
> **Organizator:** ATAM - Air To Air Meeting #37 (Sławek "Hesja" Krajniewski, [hesja.pl](https://hesja.pl))
...
Hero u góry - kadr Tomasza Filipiaka (TOMI Photography). Poniżej pierwsza partia zdjęć z lotu: POV z kamery ogonowej SP-EKS (fot. Paweł Mamcarz), Lim-5 Bartka Maciejczyka w formacji oraz zdjęcie grupowe ze Skyvanem. Reszta dochodzi w miarę jak fotografowie ATAM #37 obrabiają i wysyłają swój materiał.

**Aktualnie 15 kadrów w galerii** (POV ogonowe, Lim-5 frontalnie, zdjęcie grupowe, BTS z kokpitu, G-meter po sesji). Lista plików w `/public/gallery/ATAM37_*` - przy syncu mogę pododać/usunąć ujęcia, podać który ma być "wide" w gridzie, zmienić kolejność.
