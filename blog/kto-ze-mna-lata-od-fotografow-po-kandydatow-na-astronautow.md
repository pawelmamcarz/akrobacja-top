> SOURCE TEKSTU dla `/public/blog/kto-ze-mna-lata-od-fotografow-po-kandydatow-na-astronautow.html`.
> Edytuj tu w Obsidianie — daj mi znać "zsynchronizuj kto-ze-mna-lata-od-fotografow-po-kandydatow-na-astronautow" a wprowadzę zmiany do HTML.
...
Piloci z licencją PPL(A), którzy chcą zrobić [kurs FCL.800](/blog/kurs-akrobacji-fcl800) lub wystartować w zawodach akrobacyjnych. Zaczynają od pakietu **Masterclass** (4 999 PLN, 2 loty, pełny program akrobacyjny), żeby sprawdzić, czy to jest ich droga, zanim zainwestują w 20 999 PLN kursu.
...
- **Dezorientację przestrzenną**, niezbędna umiejętność do powrotu do orientacji
...
**Samolot akrobacyjny jako narzędzie treningu:** w środowisku cywilnym niewiele jest urządzeń, które potrafią dać +5G i −2G w kontrolowanym otoczeniu. Wirówki medyczne są drogie i rzadkie. Extra 300L jest dostępny, bezpieczny, i prowadzony przez pilota z 4 000+ h nalotu.

## Grupa 5: Firmy, event, integracja, klient VIP

Sponsorzy na pokazach, klienci VIP firmy, prezes działu sprzedaży, który dostał lot na emeryturze. Specyficzna grupa, latam z nimi w kontekście biznesowym, często jako część pakietu [pokaz + loty VIP](/pokazy-lotnicze). Przed lotem zawsze pytamy o stan zdrowia i pisemną zgodę, to są zwykle osoby 50+, czasem pierwszy raz w małym samolocie.
...
1.  **Zaufanie.** Wsiadasz do samolotu, który za moment wykona figury niemożliwe do wykonania w zwykłym samolocie. Musisz zaufać pilotowi i maszynie. To zaufanie buduję przez briefing, przez opowiedzenie tego, co się wydarzy, i przez konsekwentne dotrzymywanie obietnicy.
2.  **Przygotowanie.** Każdy lot zaczyna się na ziemi. Briefing 20-40 minut (w zależności od pakietu), sprawdzenie spadochronu, pasy, procedura awaryjna, oddech w momencie przeciążenia. Im lepiej przygotowany pasażer, tym więcej dostaje z lotu.
3.  **Jedność doświadczenia.** W powietrzu nie ma hierarchii. Są dwie osoby w samolocie, pilot i pasażer, i obie ciągną tę samą linkę. Niezależnie, czy to jest fotograf czy kandydat na astronautę.
